...
int main() {
	...
	BoolVector bv1(8); // Vector of length 8 bit
	std::cout << "Test 1 passed: Vector created." << std::endl;

	// Test 2: Setting bits
	bv1.setBitValue(3, true);
	std::cout << "Test 2 passed: Bit set." << std::endl;

	bv1.setBitValue(5, true);
	std::cout << "Test 2.1 passed: Second bit set." << std::endl;

	// Test 3: Resetting bits
	bv1.setBitValue(3, false);
	std::cout << "Test 3 passed: Bit reset." << std::endl;

	// Test 4: Inverting bits
	bv1.invert(5); // Invert bit at index 5
	std::cout << "Test 4 passed: Bits inverted." << std::endl;

	// Test 5: Setting multiple bits
	bv1.setBits(0, 4, true); // Set the first 4 bits to 1
	std::cout << "Test 5 passed: Multiple bits set." << std::endl;

	// Test 6: Inverting all bits
	bv1.invert();
	std::cout << "Test 6 passed: All bits inverted." << std::endl;

	// Test 7: Checking copy
	BoolVector bv2(bv1); // Copy bv1 to bv2
	std::cout << "Test 7 passed: Copy check." << std::endl;

	// Test 8: Initialization from string
	const char* bitString = "11001000";
	BoolVector bv3(bitString);
	std::cout << "Test 8 passed: Initialized from string." << std::endl;
